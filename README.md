...
2  Apple gourd :
<img width="1280" height="1094" alt="image" src="https://github.com/user-attachments/assets/7163c0a8-4676-4366-b4c3-ce02d7bd4e95" />
 ...
 3.Ash Gourd : 
 <img width="1280" height="720" alt="image" src="https://github.com/user-attachments/assets/ad384b44-8c78-43b9-8052-9783b03c0490" />
   Scientific Name: Benincasa hispida
   Meaning / Description: A wax-covered melon used in soups and desserts; also called winter melon.


 4. Bitter gourd :
   <img width="1200" height="900" alt="image" src="https://github.com/user-attachments/assets/658cb18e-92bf-4532-8c94-ddc30a7b4927" />
    Scientific Name: Momordica charantia
   Meaning / Description: A bitter-tasting vegetable known for medicinal and anti-diabetic properties.

 5. Bottle gourd :
     <img width="1600" height="1067" alt="image" src="https://github.com/user-attachments/assets/787e5ef7-4a27-459d-b9e3-c4952e4290bc" />
     Scientific Name :Lagenaria siceraria
	 Meaning / Description: A vine-grown vegetable shaped like a bottle, often used in cooking and containers.
    
 6.Cucumber :
     <img width="1881" height="2700" alt="image" src="https://github.com/user-attachments/assets/d601fc53-37e6-467b-90b8-dbc3ffe0fa87" />
   Scientific Name : Cucumis sativus
    Meaning / Description: A green, refreshing vegetable commonly eaten raw in salads.

 7. Ivy gourd :
      <img width="1152" height="864" alt="image" src="https://github.com/user-attachments/assets/a11b1283-27eb-4b92-8b59-043d3dc37ed5" />
       Scientific Name : Coccinia grandis
       Meaning / Description:  A tropical climbing vine with edible fruits used in Asian cuisine.

 8. Colocynth :
    <img width="724" height="483" alt="image" src="https://github.com/user-attachments/assets/5db2f132-d4ac-441d-8423-39a61ebe9727" />
    Scientific Name : Citrullus colocynthis
     Meaning / Description:  A desert vine plant with bitter fruit traditionally used in herbal medicine.

 9. Musk Melon :
     <img width="2592" height="1944" alt="image" src="https://github.com/user-attachments/assets/e59fbdce-b64f-4610-9376-6eb56bccf175" />
     Scientific Name : Cucumis melo
      Meaning / Description: A sweet and aromatic melon, including cantaloupe varieties.

 10. Peanut :
     <img width="250" height="371" alt="image" src="https://github.com/user-attachments/assets/9f3f1e86-98b9-4bee-bfb2-d935bd395335" />
     Scientific Name : Arachis hypogaea
     Meaning / Description: A legume producing edible seeds underground, rich in protein and oil.

  11. Pointed Gourd :
      <img width="1000" height="1000" alt="image" src="https://github.com/user-attachments/assets/4000725b-460c-44b4-8969-2bd3e0875e3b" />
     Scientific Name : Trichosanthes dioica
       Meaning / Description: A small green vegetable popular in Indian cooking.

   12. Ridge Gourd:
       <img width="500" height="500" alt="image" src="https://github.com/user-attachments/assets/302dcefb-82b2-4975-b378-8a59f7332326" />
    Scientific Name : Luffa acutangula
      Meaning / Description: A ridged vegetable used in cooking and known for its fibrous texture.


   13. Snake Gourd :
       <img width="339" height="462" alt="image" src="https://github.com/user-attachments/assets/b212326d-12fc-4da2-abb4-9d3fbb5100a1" />
      Scientific Name : Trichosanthes cucumerina
	   Meaning / Description : A long, snake-shaped vegetable used in tropical cuisines.

   14. Sponge Gourd :
       <img width="1280" height="720" alt="image" src="https://github.com/user-attachments/assets/17454dd1-f8c7-4fdd-ab67-662e05ee0317" />
      Scientific Name : Luffa cylindrica / Luffa aegyptiaca
      Meaning / Description : A vegetable that becomes a natural sponge when mature and dried.

   15. Strawberry :
       <img width="1200" height="800" alt="image" src="https://github.com/user-attachments/assets/f3e96e32-74f4-4ad4-8e8e-d4254911b6f3" />
    Scientific Name : Fragaria × ananassa
      Meaning / Description : A sweet red fruit known for its flavor and vitamin C content.
    16 Sweet Potato:
	   <img width="1089" height="1600" alt="image" src="https://github.com/user-attachments/assets/db9deae8-849c-4ffb-89f6-f02f17ea37d2" />
      Scientific Name : Ipomoea batatas
	   Meaning / Description : A nutritious root crop rich in carbohydrates and beta-carotene.
    17. Watermelon :
	  <img width="168" height="300" alt="image" src="https://github.com/user-attachments/assets/6eca46dc-aabd-42d2-bc54-33845f2b8db4" />
      Scientific Name : Citrullus lanatus
        Meaning / Description :  A large juicy fruit with high water content and sweet flesh.
    18.Winter Melon :
       <img width="1500" height="1000" alt="image" src="https://github.com/user-attachments/assets/eefd7632-ddac-4826-9667-522347c9d098" />
      Scientific Name : Benincasa hispida
	   Meaning / Description :A large melon stored for long periods and used in soups and sweets.
    19.Zucchini :
       <img width="1800" height="1200" alt="image" src="https://github.com/user-attachments/assets/e2869ad2-e3db-41b4-ae62-3e703a9a3e2f" />
        Scientific Name : Cucurbita pepo
          Meaning / Description : A soft-skinned summer squash commonly cooked or eaten fresh.
    20. Squash :
       <img width="1155" height="648" alt="image" src="https://github.com/user-attachments/assets/ff2512f6-3e79-4dfe-b4ce-f1c4a68fa2b3" />
        Scientific Name : Cucurbita species
          Meaning / Description : A group of edible gourds including pumpkins and zucchini.
